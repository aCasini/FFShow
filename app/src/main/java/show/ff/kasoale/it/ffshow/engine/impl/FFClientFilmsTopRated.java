...
public class FFClientFilmsTopRated extends AbstractRESTfulClient {

    private static Logger logger = Logger.getLogger("FFClientFilmsTopRated");
    private HashMap<String, String> queryParametersMap;

    private final String HTTP_URL = "https://ancient-tor-87034.herokuapp.com/films/top_rated";
