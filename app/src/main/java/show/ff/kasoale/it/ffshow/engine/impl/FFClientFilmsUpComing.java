...
public class FFClientFilmsUpComing extends AbstractRESTfulClient {

    private static Logger logger = Logger.getLogger("FFClientFilmsUpComing");
    private HashMap<String, String> queryParametersMap;

    private final String HTTP_URL = "https://ancient-tor-87034.herokuapp.com/films/upcoming";
